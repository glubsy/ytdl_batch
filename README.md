...
The script uses regex pattern matching to extract 11-character YouTube video IDs from filenames, supports multiple video formats (mkv, mp4, opus, m4a, webm), and outputs results to `ids_found_on_disk.txt` with one ID per line prefixed with "youtube.com".
...
**Output file format:**
```
youtube.com VIDEO_ID_1
youtube.com VIDEO_ID_2
...
```
